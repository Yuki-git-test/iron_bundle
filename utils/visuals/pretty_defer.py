...
async def pretty_defer(
    ...
    content: str = "Please wait while Iron Bundle thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Iron Bundle loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Iron Bundle.
    - Always ephemeral.
    - Uses Iron Bundle's error emoji.
